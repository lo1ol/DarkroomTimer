...
4. Click extra btn when timer during run to see short log
5. Hold extra btn to reset current printing at any mode (inside mask mode you can fast travel between masks)
6. Turn encoder inside during run to scroll time table
