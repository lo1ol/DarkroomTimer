...
6. Удерживай нопку просмотра и переключения режима, чтобы войти в режим настроек (можно устанавливать лаг запуска лампы, подсветку, громкость пищалки, таймер автоотключения лампы при просмотре и настройка "стартовать с настроек")
