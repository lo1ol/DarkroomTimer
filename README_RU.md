...
8. Локализованные тестовые режимы: аналогичны тестам F стопами и линейным тестам, но используемые для печати одинаково сегмента. Время которое сейчас показывается -- полное время печати теста.
