...
5. Кликни кнопку на энкодере, когда таймер готов к печати, чтобы переключить режим просмотра
6. Удерживай кнопку на энкодере, чтобы сбросить печать в любом режиме
7. Кликни кнопку старта, чтобы начать печать в любом режиме
8. Удерживай нопку просмотра и переключения режима, чтобы войти в режим настроек (можно устанавливать лаг запуска лампы, подсветку, громкость пищалки, таймер автоотключения лампы при просмотре и настройка "стартовать с настроек")
