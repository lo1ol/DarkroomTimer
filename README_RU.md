...
3. [Красный LCD 1602](https://sl.aliexpress.ru/p?key=tgDHsiN)
4. [Активный зумер 5V](https://sl.aliexpress.ru/p?key=iXIeG78)
5. [Переключатель SS12F15G5 2 шт.](https://sl.aliexpress.ru/p?key=f3PfsRC)
6. [Трансформатор на 5V 700mA](https://sl.aliexpress.ru/p?key=5RdhGtS) (Не проверен полноценно). Также  вы можете просто разобрать любую 5В USB зарядку для телефона
7. [Arduino Nano ATMEGA328P/Type-C или Mini USB/без припаянных пинов](https://sl.aliexpress.ru/p?key=daDhGj5)
...
12. [LCD с I2C адаптером](https://sl.aliexpress.ru/p?key=W3wrV2z) (Опционален. Не проверен. Альтернатива обычному LCD). Плюсы и минусы такой версии:
    * легче припаивать -- нужно припаять 5 пинов: GND, VCC, SDA -> A4, SCL -> A5, K -> Пин контроля яркости (D5)
    * может работать с электромагнитным реле без графических артефактов. Но я все еще не рекомендую использовать электромагнитное реле с ним т.к. оно может разрушить ваше устройство из-за обратного тока
    * дисплей становится менее отзывчивым на повороты энкодера. [Демонстрация](https://youtu.be/_PjdLxWIzHs)
    * не нужный резистор для регулировки контраста. Для регулировки на адаптере уже есть потенциометр
